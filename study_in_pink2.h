...
public:
    ...
    bool isStop() const
    {
        return  sherlock->getHP() == 1 || watson->getHP() == 1 || criminal->getCurrentPosition().isEqual(watson->getCurrentPosition())||criminal->getCurrentPosition().isEqual(sherlock->getCurrentPosition());
    }
    void printResult() const //! mở ra khi nộp
    {
    ...
    void printStep(int si) const //! ở ra khi nộp
    {
